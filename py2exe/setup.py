...
setup(console=['ampbalance_v2P.py'],options={"py2exe":{"includes":["h5py.*","cython.*","scipy.special.*","scipy.linalg.*","scipy.sparse.csgraph._validation","mlpy.*"], "dll_excludes": ["MSVCP90.dll"] ,"excludes": ["IPython", "Tkinter", "tcl"]}})
